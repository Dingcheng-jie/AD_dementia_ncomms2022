...
def main(raw_folder, root_folder, mode_flag, step_7_f, step_7_g):
    ...
    # create folder
    scan_folder = raw_folder+root_folder + '/scans'
    create_folder(scan_folder)
    create_folder(raw_folder+root_folder + '/images')
    create_folder(raw_folder+root_folder + '/tmp')
    create_folder(raw_folder+root_folder + '/'+ mode_flag)
    ...
    if mode_flag == 'images': # if mode_flag is "images", run until all processed cases are saved in the images folder
        ...
        good_dict = find_cases(raw_folder+root_folder + '/good', '.jpg')
